...
(
    ...
    agencys_id int references agencys(id),
...
ALTER TABLE agencys
    ADD CONSTRAINT phone_number_check CHECK (phone_number ~ '[0-9]{10}');
...
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Serene', 'Roggerone', 'sroggeronej@shop-pro.jp', '1988-06-13', 'Female', 'French', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Rafaellle', 'Hannent', 'rhannentk@miitbeian.gov.cn', '1974-10-14', 'Male', 'Icelandic', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Aveline', 'Aslum', 'aasluml@w3.org', '1994-12-23', 'Female', 'Kurdish', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Gloria', 'Powrie', 'gpowriem@msn.com', '1986-11-19', 'Female', 'Malay', 'Widow');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Tilek', 'Adam', 'tcrimminsn@google.co.uk', '1990-01-18', 'Male', 'Kyrgyz', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Felike', 'Jurisic', 'fjurisico@joomla.org', '1994-08-24', 'Male', 'Guaraní', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Kailey', 'Gate', 'kgatep@lycos.com', '1987-04-21', 'Female', 'Malayalam', 'Widow');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Ronna', 'Genge', 'rgengeq@admin.ch', '1982-01-04', 'Female', 'Thai', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Hamish', 'Flisher', 'hflisherr@webnode.com', '1982-10-08', 'Male', 'Icelandic', 'Divorced');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Trula', 'Gheraldi', 'tgheraldis@paginegialle.it', '1988-01-06', 'Female', 'Malayalam', 'Divorced');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Fran', 'Olander', 'folandert@nsw.gov.au', '1974-11-14', 'Male', 'Indonesian', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Arlana', 'Glass', 'aglassu@stanford.edu', '1983-10-30', 'Female', 'Bosnian', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Esma', 'Doerr', 'edoerrv@51.la', '1983-06-13', 'Female', 'English', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Rhiamon', 'MacLaig', 'rmaclaigw@feedburner.com', '1992-07-19', 'Female', 'Hebrew', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Hunt', 'Minchinton', 'hminchintonx@mac.com', '1969-09-26', 'Male', 'German', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Kamila', 'Armanova', 'kama@aboutads.info', '1994-02-02', 'Female', 'Kyrgyz', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Berne', 'Armall', 'barmallz@e-recht24.de', '1980-09-28', 'Male', 'Belarusian', 'Widow');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Crista', 'Skeene', 'cskeene10@hp.com', '1970-01-25', 'Female', 'Gujarati', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Fernanda', 'Bullen', 'fbullen11@abc.net.au', '1966-12-14', 'Female', 'Bosnian', 'Divorced');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Malika', 'Alikova', 'malika@last.fm', '1988-02-22', 'Female', 'Kyrgyz', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Zackariah', 'Gelardi', 'zgelardi13@usa.gov', '1986-01-04', 'Male', 'Hungarian', 'Widow');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Frans', 'Colls', 'fcolls14@japanpost.jp', '1989-08-24', 'Male', 'Hindi', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Ali', 'Jumabek', 'ali@imgur.com', '1993-11-14', 'Male', 'Kyrgyz', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Shirleen', 'Hasley', 'shasley16@dmoz.org', '2019-07-12', 'Female', 'Chineese', 'Widow');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Garrott', 'Beccles', 'gbeccles17@foxnews.com', '2001-04-11', 'Male', 'Tsonga', 'Single');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Uulkan', 'Beisheeva', 'uulkan@xinhuanet.com', '1980-05-12', 'Female', 'Kyrgyz', 'Divorced');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Rosana', 'Mucci', 'rmucci19@fotki.com', '1970-05-07', 'Female', 'Czech', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Neils', 'Aronson', 'naronson1a@time.com', '1976-12-18', 'Male', 'German', 'Married');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Nicol', 'Tipple', 'ntipple1b@theatlantic.com', '1997-07-19', 'Male', 'Turkish', 'Widow');
insert into customer (first_name, last_name, email, date_of_birth, gender, nationality, family_status) values ('Leandra', 'Swancott', 'lswancott1c@thetimes.co.uk', '1985-04-14', 'Female', 'English', 'Single');
...
insert into agencys (name, phone_number, address_id) values ('House_kg', '+996700919191', 1);
insert into agencys (name, phone_number, address_id) values ('Apartment Agency', '+996550123456', 2);
insert into agencys (name, phone_number, address_id) values ('Rent Agency', '+996999098765', 3);
insert into agencys (name, phone_number, address_id) values ('Comfort House', '+996500789098', 4);
insert into agencys (name, phone_number, address_id) values ('My House', '+996086123456', 5);
insert into agencys (name, phone_number, address_id) values ('Sweet Home', '+996709123456', 6);
insert into agencys (name, phone_number, address_id) values ('Kg_apartment', '+996700789876', 7);
insert into agencys (name, phone_number, address_id) values ('Rent_Apartment', '+996700987654', 8);
insert into agencys (name, phone_number, address_id) values ('Get House', '+996700987654', 9);
insert into agencys (name, phone_number, address_id) values ('Flat_rent', '+996550418756', 10);
...
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (1, 1, 1, 1, '2021-10-12', '2021-10-27');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (2, 2, 2, 5, '2021-01-19', '2022-11-13');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (3, 3, 3, 3, '2021-12-12', '2022-03-24');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (20, 4, 4, 4, '2021-01-27', '2021-08-31');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (5, 5, 5, 2, '2022-07-05', '2023-01-16');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (6, 6, 6, 6, '2021-01-22', '2021-08-30');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (7, 7, 7, 7, '2019-08-08', '2022-02-04');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (8, 8, 8, 8, '2021-04-06', '2021-05-21');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (9, 9, 9, 9, '2020-11-07', '2022-07-05');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (22, 10, 10, 10, '2022-03-18', '2023-01-10');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (11, 11, 1, 11, '2018-02-03', '2021-02-04');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (12, 12, 2, 12, '2021-12-09', '2023-01-08');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (13, 13, 3, 13, '2021-03-15', '2022-10-13');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (10, 14, 4, 14, '2022-04-22', '2022-06-16');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (15, 15, 5, 15, '2020-08-27', '2021-08-05');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (16, 16, 6, 16, '2019-04-27', '2020-12-03');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (17, 17, 7, 17, '2021-01-01', '2021-12-31');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (10, 18, 8, 18, '2020-05-24', '2021-02-20');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (32, 19, 9, 19, '2019-09-27', '2020-07-31');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (4, 20, 10, 20, '2021-12-21', '2022-06-20');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (21, 21, 1, 21, '2021-12-09', '2023-01-01');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (10, 22, 2, 22, '2022-01-20', '2022-08-05');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (13, 23, 3, 23, '2020-12-03', '2021-04-22');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (24, 24, 4, 24, '2022-12-26', '2023-01-16');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (33, 25, 5, 25, '2020-02-07', '2021-08-19');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (26, 26, 1, 26, '2019-09-10', '2021-09-19');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (6, 27, 2, 27, '2021-05-02', '2021-12-21');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (28, 28, 3, 28, '2022-01-16', '2022-12-13');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (29, 29, 7, 29, '2020-11-09', '2021-05-04');
insert into rent_info (owner_id, customer_id, agencys_id, houses_id, check_in_date, check_out_date) values (30, 30, 8, 30, '2022-05-08', '2022-12-29');


--1. Owner_лердин аттарынын арасынан эн коп символ камтыган owner_ди жана анын уйун(House) чыгар.
select * from owners owner inner join houses h on owner.id = h.owner_id where owner.length(first_name);
